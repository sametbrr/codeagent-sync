...
<d:multistatus xmlns:d="DAV:" xmlns:s="http://sabredav.org/ns" xmlns:oc="http://owncloud.org/ns" xmlns:nc="http://nextcloud.org/ns">
  <d:response>
    <d:href>/remote.php/dav/files/user/codeagent-sync/</d:href>
    <d:propstat>
      <d:prop>
  ...
  <d:response>
    <d:href>/remote.php/dav/files/user/codeagent-sync/sessions/abc123.enc</d:href>
    <d:propstat>
      <d:prop>
        <d:resourcetype/>
  ...
  <d:response>
    <d:href>/remote.php/dav/files/user/codeagent-sync/settings.enc</d:href>
    <d:propstat>
      <d:prop>
        <d:resourcetype/>
	...
	// Kept in the quoted wire form that If-Match expects.
	if results[1].ETag != `"abc123def456"` {
		t.Errorf("expected etag %q, got %q", `"abc123def456"`, results[1].ETag)
	}
...
<d:multistatus xmlns:d="DAV:">
  <d:response>
    <d:href>/remote.php/dav/files/user/codeagent-sync/path%20with%20spaces/file.enc</d:href>
    <d:propstat>
      <d:prop>
        <d:resourcetype/>
	...
	expected := "/remote.php/dav/files/user/codeagent-sync/path with spaces/file.enc"
...
<d:multistatus xmlns:d="DAV:">
  <d:response>
    <d:href>/remote.php/dav/files/user/codeagent-sync/file.enc</d:href>
    <d:propstat>
      <d:prop>
